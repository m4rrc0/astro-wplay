;(function e(t, r) {
  ...
  else if (typeof exports === 'object') exports['SwupScriptsPlugin'] = r()
  else t['SwupScriptsPlugin'] = r()
})(window, function () {
  return (function (e) {
    var t = {}
    function r(n) {
    ...
    function (e, t, r) {
      ...
      var p = (function (e) {
        ...
        function t(e) {
          ...
          r.name = 'ScriptsPlugin'
          r.runScripts = function () {
            var e =
              r.options.head && r.options.body
                ? document
                : r.options.head
                  ? document.head
                  : document.body
            var t = r.options.optin
              ? 'script[data-swup-reload-script]'
              : 'script:not([data-swup-ignore-script])'
            var n = s(e.querySelectorAll(t))
            n.forEach(function (e) {
              return r.runScript(e)
            })
            r.swup.log('Executed ' + n.length + ' scripts.')
          }
          r.runScript = function (e) {
            ...
            try {
              for (
                var u = s(e.attributes)[Symbol.iterator](), i;
                !(r = (i = u.next()).done);
                r = true
              ) {
                var a = i.value
          ...
          var o = { head: true, body: true, optin: false }
          r.options = n({}, o, e)
          return r
        }
        o(t, [
